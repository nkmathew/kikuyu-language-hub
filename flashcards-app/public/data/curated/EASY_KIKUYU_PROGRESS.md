...
| Batch | Files | Flashcards | Status | Date | Notes |
|-------|-------|------------|--------|------|-------|
| 001 | 001-014 | 8 | ✅ Complete | - | Initial batch, documented in EASY_KIKUYU_BATCH_001.md |
| 002 | 015-024 | - | ✅ Complete | - | - |
| 003 | 025-034 | - | ✅ Complete | - | - |
| 004 | 035-044 | - | ✅ Complete | - | - |
| 005 | 045-054 | - | ✅ Complete | - | - |
| 006 | 055-064 | - | ✅ Complete | - | - |
| 007 | 065-074 | - | ✅ Complete | - | - |
| 008 | 075-084 | - | ✅ Complete | - | Traditional riddles, grammar particle 'No', vocabulary |
| 009 | 085-094 | - | ✅ Complete | - | Monosyllables, traditional dances, versatile verbs |
| 010 | 095-104 | - | ✅ Complete | - | Noun classes, numbers, clothing, wildlife |
| 011 | 105-114 | - | ✅ Complete | - | Nuanced vocabulary, introduction conversations |
| 012 | 115-124 | - | ✅ Complete | - | - |
| 013 | 125-134 | - | ✅ Complete | - | - |
| 014 | 135-144 | - | ✅ Complete | - | - |
| 015 | 145-154 | - | ✅ Complete | - | - |
| 016 | 155-164 | - | ✅ Complete | - | - |
| 017 | 165-174 | - | ✅ Complete | - | - |
| 018 | 175-184 | - | ✅ Complete | - | - |
| 019 | 185-194 | - | ✅ Complete | - | - |
| 020 | 195-204 | - | ✅ Complete | - | - |
| 021 | 205-214 | - | ✅ Complete | - | - |
| 022 | 215-224 | - | ✅ Complete | - | - |
| 023 | 225-234 | - | ✅ Complete | - | - |
| 024 | 235-244 | - | ✅ Complete | - | - |
| 025 | 245-254 | - | ✅ Complete | - | - |
...
**Difficulty**: Beginner (15), Intermediate (24), Advanced (6)

### Key Content Areas:
1. **Questions & Commands** (275-277)
   - Asking questions about choices
   - Command phrases for conversation
   - Writing and prayer vocabulary

2. **Professions** (278)
   - Handyman, carpenter, farmer, driver
   - Leaders, police, priests
   - Subject pronouns with professions

3. **COVID-19 Vocabulary** (279, 282-283)
   - Three words for "mask"
   - Infection reporting
   - Safety measures (washing hands, social distancing)

4. **Entertainment & Storytelling** (280-281)
   - Comedy/laughter vocabulary
   - Traditional storytelling openings
   - Tonal distinctions (arrive vs. step on)
   - Fear vocabulary

5. **Basic Vocabulary** (284)
   - Days of the week (Friday, Saturday)
   - Ability/capability verbs

### Notable Features:
- **Tonal Distinctions**: Gũkinya (arrive, monotone) vs GũkiNYA (step on, rising tone)
- **Cultural Context**: Traditional storytelling formula "Tene tene rĩ" with response "ĩ"
- **Geographic Nuance**: bũrũriinĩ wa Kũraya (far away in Africa) vs wa Rũraya (outside Africa)
- **Contemporary Vocabulary**: COVID-19 related terms showing language adaptation
- **Borrowed Words**: mathiki (English 'mask'), mbarakoa (Swahili 'barakoa')

## Quality Metrics
- **Average Quality Score**: 4.7/5
- **High Quality (4.8-4.9)**: 7 flashcards
...
`easy_kikuyu_batch_[XXX]_vocab.json`
- XXX = batch number (zero-padded to 3 digits)
- Location: `flashcards-app/public/data/curated/vocabulary/`
