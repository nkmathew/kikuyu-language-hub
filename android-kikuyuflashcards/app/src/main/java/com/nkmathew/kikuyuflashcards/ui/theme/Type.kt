...
val Typography = Typography(
    // Display styles - for large headlines and important content
    ...
    // Body styles - for main content and phrases
    bodyLarge = TextStyle(
        fontFamily = FontFamily.Default,
...
// Custom typography for flash cards with better readability
val FlashCardTypography = Typography(
    // Large text for main phrases on flash cards
    displayMedium = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.SemiBold,
        fontSize = 24.sp,
